...
<body>
    ...
    <div class="fffx">
        ...
        <div class="containerFAQ McontainerFAQ">            
            <section class="faq-section Mfaq-section">
                <h1 class="faqtitle Mfaqtitle">FAQ</h1>
                    <div class="div-faq Mdiv-faq">
                        <div class="dropdown-trigger Mdropdown-trigger">
                            ...
                            <div class="dropdown-content Mdropdown-content">
                    ...
                    <div class="div-faq2 Mdiv-faq2">
                        <div class="dropdown-trigger Mdropdown-trigger">
                            <h2 class="qtrigger Mqtrigger">What are your departure and arrival times?</h2>
                            <button class="btntrigger Mbtntrigger">
                                +
                            </button>
                            <div class="dropdown-content Mdropdown-content">
                    ...
                    <div class="div-faq2 Mdiv-faq2">
                        <div class="dropdown-trigger Mdropdown-trigger">
                            <h2 class="qtrigger Mqtrigger">How much is the cost per person to travel?</h2>
                            <button class="btntrigger Mbtntrigger">
                                +
                            </button>
                            <div class="dropdown-content Mdropdown-content">
                    ...
                    <div class="div-faq2 Mdiv-faq2">
                        <div class="dropdown-trigger Mdropdown-trigger">
                            <h2 class="qtrigger Mqtrigger">How to make a reservation?</h2>
                            <button class="btntrigger Mbtntrigger">
                                +
                            </button>
                            <div class="dropdown-content Mdropdown-content">
                    ...
                    <div class="div-faq2 Mdiv-faq2">
                        <div class="dropdown-trigger Mdropdown-trigger">
                            <h2 class="qtrigger Mqtrigger">How do I pay for my reservation?</h2>
                            <button class="btntrigger Mbtntrigger">
                                +
                            </button>
                            <div class="dropdown-content Mdropdown-content">
                    ...
                    <div class="div-faq2 Mdiv-faq2">
                        <div class="dropdown-trigger Mdropdown-trigger">
                            <h2 class="qtrigger Mqtrigger">What will I receive to show my reservation is confirmed?</h2>
                            <button class="btntrigger Mbtntrigger">
                                +
                            </button>
                            <div class="dropdown-content Mdropdown-content">
                    ...
                    <div class="div-faq2 Mdiv-faq2">
                        <div class="dropdown-trigger Mdropdown-trigger">
                            <h2 class="qtrigger Mqtrigger">Does my child need to pay for a ticket?</h2>
                            <button class="btntrigger Mbtntrigger">
                                +
                            </button>
                            <div class="dropdown-content Mdropdown-content">
                    ...
                    <div class="div-faq2 Mdiv-faq2">
                        <div class="dropdown-trigger Mdropdown-trigger">
                            <h2 class="qtrigger Mqtrigger">What is the cancelation policy?</h2>
                            <button class="btntrigger Mbtntrigger">
                                +
                            </button>
                            <div class="dropdown-content Mdropdown-content">
                    ...
                    <div class="div-faq2 Mdiv-faq2">
                        <div class="dropdown-trigger Mdropdown-trigger">
                            <h2 class="qtrigger Mqtrigger">What if I missed my Bus?</h2>
                            <button class="btntrigger Mbtntrigger">
                                +
                            </button>
                            <div class="dropdown-content Mdropdown-content">
                    ...
                    <div class="div-faq2 Mdiv-faq2">
                        <div class="dropdown-trigger Mdropdown-trigger">
                            <h2 class="qtrigger Mqtrigger">Times posted are?</h2>
                            <button class="btntrigger Mbtntrigger">
                                +
                            </button>
                            <div class="dropdown-content Mdropdown-content">
                    ...
                    <div class="div-faq2 Mdiv-faq2">
                        <div class="dropdown-trigger Mdropdown-trigger">
                            <h2 class="qtrigger Mqtrigger">Are Pets allowed to travel?</h2>
                            <button class="btntrigger Mbtntrigger">
                                +
                            </button>
                            <div class="dropdown-content Mdropdown-content">
                    ...
                    <div class="div-faq2 Mdiv-faq2">
                        <div class="dropdown-trigger Mdropdown-trigger">
                            <h2 class="qtrigger Mqtrigger">May a child travel alone on your trips?</h2>
                            <button class="btntrigger Mbtntrigger">
                                +
                            </button>
                            <div class="dropdown-content Mdropdown-content">
                    ...
                    <div class="div-faq2 Mdiv-faq2">
                        <div class="dropdown-trigger Mdropdown-trigger">
                            <h2 class="qtrigger Mqtrigger">What amenities are on board?</h2>
                            <button class="btntrigger Mbtntrigger">
                                +
                            </button>
                            <div class="dropdown-content Mdropdown-content">
