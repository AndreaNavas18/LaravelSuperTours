...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('reservas', function (Blueprint $table) {
            ...
            $table->integer('tarifa_one')->default(0);
            $table->integer('fromt2')->default(0);
            $table->integer('tot2')->default(0);
            $table->integer('tarifa_round')->default(0);
            ...
            $table->string('fecha_salida_ns', 20)->nullable();
            $table->string('fecha_retorno', 10)->nullable();
            $table->string('fecha_retorno_ns', 20)->nullable();
            ...
            $table->integer('pax_r')->comment('adult_r');
            $table->integer('pax2_r')->comment('child_r');
            $table->integer('pax3_r')->comment('infat_r');
            ...
            $table->double('net_rate_ida', 10, 2);
            $table->double('net_rate_vuelta', 10, 2);
            ...
            $table->integer('estado_one')->default(1);
            $table->integer('estado_round')->default(1);
            $table->integer('viajes_one')->default(0);
            $table->integer('viajes_round')->default(0);
            $table->string('reference', 25);
            $table->string('confir_dep', 80);
            $table->string('confir_ret', 80);
        });
    }
