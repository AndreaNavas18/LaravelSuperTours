...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('routes', function (Blueprint $table) {
            ...
            $table->string('trip_departure', 7);
            $table->string('trip_arrival', 7);
            $table->char('anno', 4);
            ...
            $table->integer('capacity2')->default(0);
            $table->integer('capacity3')->default(0);
            $table->integer('capacity4')->default(0);
            $table->integer('capacity5')->default(0);
            $table->string('seats_remain', 7);
            $table->double('spprc_adult', 10, 2);
            $table->double('spprc_child', 10, 2);
            $table->double('sdprc_adult', 10, 2);
            $table->double('sdprc_child', 10, 2);
            $table->double('wfprc_adult', 10, 2);
            $table->double('wfprc_child', 10, 2);
            $table->double('stprc_adult', 10, 2);
            $table->double('stprc_child', 10, 2);
            $table->double('sflexprc_adult', 10, 2);
            $table->double('sflexprc_child', 10, 2);
            $table->double('net_rate', 10, 2);
            $table->double('flresprc_adult', 10, 2);
            $table->double('flresprc_child', 10, 2);
            $table->integer('spseats');
            $table->integer('sdseats');
            $table->integer('wfseats');
            $table->integer('stseats');
            $table->integer('sflexseats');
            $table->integer('spprcseats');
            $table->integer('toursseats');
